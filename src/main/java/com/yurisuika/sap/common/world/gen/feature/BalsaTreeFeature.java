...
public class BalsaTreeFeature extends AbstractSmallTreeFeature<TreeFeatureConfig> {
   public BalsaTreeFeature(Function<Dynamic<?>, ? extends TreeFeatureConfig> p_i225820_1_) {
      super(p_i225820_1_);
   }
