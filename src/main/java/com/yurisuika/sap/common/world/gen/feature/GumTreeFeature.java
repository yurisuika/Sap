...
public class GumTreeFeature extends AbstractSmallTreeFeature<TreeFeatureConfig> {
   public GumTreeFeature(Function<Dynamic<?>, ? extends TreeFeatureConfig> p_i225820_1_) {
      super(p_i225820_1_);
   }
