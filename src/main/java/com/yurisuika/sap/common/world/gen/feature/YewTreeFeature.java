...
public class YewTreeFeature extends AbstractSmallTreeFeature<TreeFeatureConfig> {
   public YewTreeFeature(Function<Dynamic<?>, ? extends TreeFeatureConfig> p_i225820_1_) {
      super(p_i225820_1_);
   }
