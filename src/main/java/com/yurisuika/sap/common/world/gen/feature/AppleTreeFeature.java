...
public class AppleTreeFeature extends AbstractSmallTreeFeature<TreeFeatureConfig> {
   public AppleTreeFeature(Function<Dynamic<?>, ? extends TreeFeatureConfig> p_i225820_1_) {
      super(p_i225820_1_);
   }
