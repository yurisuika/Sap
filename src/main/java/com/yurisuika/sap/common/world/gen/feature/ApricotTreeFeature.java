...
public class ApricotTreeFeature extends AbstractSmallTreeFeature<TreeFeatureConfig> {
   public ApricotTreeFeature(Function<Dynamic<?>, ? extends TreeFeatureConfig> p_i225820_1_) {
      super(p_i225820_1_);
   }
