...
public class MangoTreeFeature extends AbstractSmallTreeFeature<TreeFeatureConfig> {
   public MangoTreeFeature(Function<Dynamic<?>, ? extends TreeFeatureConfig> p_i225820_1_) {
      super(p_i225820_1_);
   }
