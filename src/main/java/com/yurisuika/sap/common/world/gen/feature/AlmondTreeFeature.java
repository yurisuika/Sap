...
public class AlmondTreeFeature extends AbstractSmallTreeFeature<TreeFeatureConfig> {
   public AlmondTreeFeature(Function<Dynamic<?>, ? extends TreeFeatureConfig> p_i225820_1_) {
      super(p_i225820_1_);
   }
