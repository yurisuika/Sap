...
public class OliveTreeFeature extends AbstractSmallTreeFeature<TreeFeatureConfig> {
   public OliveTreeFeature(Function<Dynamic<?>, ? extends TreeFeatureConfig> p_i225820_1_) {
      super(p_i225820_1_);
   }
