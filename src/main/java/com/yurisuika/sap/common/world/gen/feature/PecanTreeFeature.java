...
public class PecanTreeFeature extends AbstractSmallTreeFeature<TreeFeatureConfig> {
   public PecanTreeFeature(Function<Dynamic<?>, ? extends TreeFeatureConfig> p_i225820_1_) {
      super(p_i225820_1_);
   }
