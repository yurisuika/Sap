...
public class CloveTreeFeature extends AbstractSmallTreeFeature<TreeFeatureConfig> {
   public CloveTreeFeature(Function<Dynamic<?>, ? extends TreeFeatureConfig> p_i225820_1_) {
      super(p_i225820_1_);
   }
