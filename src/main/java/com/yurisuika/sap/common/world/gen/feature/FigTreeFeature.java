...
public class FigTreeFeature extends AbstractSmallTreeFeature<TreeFeatureConfig> {
   public FigTreeFeature(Function<Dynamic<?>, ? extends TreeFeatureConfig> p_i225820_1_) {
      super(p_i225820_1_);
   }
