...
public class GinkgoTreeFeature extends AbstractSmallTreeFeature<TreeFeatureConfig> {
   public GinkgoTreeFeature(Function<Dynamic<?>, ? extends TreeFeatureConfig> p_i225820_1_) {
      super(p_i225820_1_);
   }
