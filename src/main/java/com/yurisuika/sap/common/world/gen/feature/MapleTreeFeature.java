...
public class MapleTreeFeature extends AbstractSmallTreeFeature<TreeFeatureConfig> {
   public MapleTreeFeature(Function<Dynamic<?>, ? extends TreeFeatureConfig> p_i225820_1_) {
      super(p_i225820_1_);
   }
