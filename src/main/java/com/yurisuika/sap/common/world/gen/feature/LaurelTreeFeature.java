...
public class LaurelTreeFeature extends AbstractSmallTreeFeature<TreeFeatureConfig> {
   public LaurelTreeFeature(Function<Dynamic<?>, ? extends TreeFeatureConfig> p_i225820_1_) {
      super(p_i225820_1_);
   }
