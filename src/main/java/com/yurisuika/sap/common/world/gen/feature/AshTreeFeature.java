...
public class AshTreeFeature extends AbstractSmallTreeFeature<TreeFeatureConfig> {
   public AshTreeFeature(Function<Dynamic<?>, ? extends TreeFeatureConfig> p_i225820_1_) {
      super(p_i225820_1_);
   }
