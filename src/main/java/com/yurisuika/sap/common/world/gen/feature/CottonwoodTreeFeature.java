...
public class CottonwoodTreeFeature extends AbstractSmallTreeFeature<TreeFeatureConfig> {
   public CottonwoodTreeFeature(Function<Dynamic<?>, ? extends TreeFeatureConfig> p_i225820_1_) {
      super(p_i225820_1_);
   }
