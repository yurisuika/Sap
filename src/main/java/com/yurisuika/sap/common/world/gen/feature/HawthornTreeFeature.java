...
public class HawthornTreeFeature extends AbstractSmallTreeFeature<TreeFeatureConfig> {
   public HawthornTreeFeature(Function<Dynamic<?>, ? extends TreeFeatureConfig> p_i225820_1_) {
      super(p_i225820_1_);
   }
