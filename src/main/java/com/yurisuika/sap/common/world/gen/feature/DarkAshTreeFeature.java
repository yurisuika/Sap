...
public class DarkAshTreeFeature extends AbstractSmallTreeFeature<TreeFeatureConfig> {
   public DarkAshTreeFeature(Function<Dynamic<?>, ? extends TreeFeatureConfig> p_i225820_1_) {
      super(p_i225820_1_);
   }
