...
public class MulberryTreeFeature extends AbstractSmallTreeFeature<TreeFeatureConfig> {
   public MulberryTreeFeature(Function<Dynamic<?>, ? extends TreeFeatureConfig> p_i225820_1_) {
      super(p_i225820_1_);
   }
