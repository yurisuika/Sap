...
public class MacadamiaTreeFeature extends AbstractSmallTreeFeature<TreeFeatureConfig> {
   public MacadamiaTreeFeature(Function<Dynamic<?>, ? extends TreeFeatureConfig> p_i225820_1_) {
      super(p_i225820_1_);
   }
