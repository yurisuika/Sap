...
public class LemonTreeFeature extends AbstractSmallTreeFeature<TreeFeatureConfig> {
   public LemonTreeFeature(Function<Dynamic<?>, ? extends TreeFeatureConfig> p_i225820_1_) {
      super(p_i225820_1_);
   }
