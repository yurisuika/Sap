...
public class PearTreeFeature extends AbstractSmallTreeFeature<TreeFeatureConfig> {
   public PearTreeFeature(Function<Dynamic<?>, ? extends TreeFeatureConfig> p_i225820_1_) {
      super(p_i225820_1_);
   }
