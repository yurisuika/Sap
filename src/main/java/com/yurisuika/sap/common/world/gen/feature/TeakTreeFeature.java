...
public class TeakTreeFeature extends AbstractSmallTreeFeature<TreeFeatureConfig> {
   public TeakTreeFeature(Function<Dynamic<?>, ? extends TreeFeatureConfig> p_i225820_1_) {
      super(p_i225820_1_);
   }
