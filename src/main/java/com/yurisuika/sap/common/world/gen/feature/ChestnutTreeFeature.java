...
public class ChestnutTreeFeature extends AbstractSmallTreeFeature<TreeFeatureConfig> {
   public ChestnutTreeFeature(Function<Dynamic<?>, ? extends TreeFeatureConfig> p_i225820_1_) {
      super(p_i225820_1_);
   }
