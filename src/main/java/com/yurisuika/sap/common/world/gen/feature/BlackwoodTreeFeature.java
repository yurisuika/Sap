...
public class BlackwoodTreeFeature extends AbstractSmallTreeFeature<TreeFeatureConfig> {
   public BlackwoodTreeFeature(Function<Dynamic<?>, ? extends TreeFeatureConfig> p_i225820_1_) {
      super(p_i225820_1_);
   }
