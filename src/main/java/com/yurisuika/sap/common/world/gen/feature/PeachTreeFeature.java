...
public class PeachTreeFeature extends AbstractSmallTreeFeature<TreeFeatureConfig> {
   public PeachTreeFeature(Function<Dynamic<?>, ? extends TreeFeatureConfig> p_i225820_1_) {
      super(p_i225820_1_);
   }
