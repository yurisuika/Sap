...
public class ElmTreeFeature extends AbstractSmallTreeFeature<TreeFeatureConfig> {
   public ElmTreeFeature(Function<Dynamic<?>, ? extends TreeFeatureConfig> p_i225820_1_) {
      super(p_i225820_1_);
   }
