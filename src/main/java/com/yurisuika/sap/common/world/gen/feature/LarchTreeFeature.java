...
public class LarchTreeFeature extends AbstractSmallTreeFeature<TreeFeatureConfig> {
   public LarchTreeFeature(Function<Dynamic<?>, ? extends TreeFeatureConfig> p_i225820_1_) {
      super(p_i225820_1_);
   }
