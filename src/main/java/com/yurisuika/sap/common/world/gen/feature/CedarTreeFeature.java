...
public class CedarTreeFeature extends AbstractSmallTreeFeature<TreeFeatureConfig> {
   public CedarTreeFeature(Function<Dynamic<?>, ? extends TreeFeatureConfig> p_i225820_1_) {
      super(p_i225820_1_);
   }
