...
public class HornbeamTreeFeature extends AbstractSmallTreeFeature<TreeFeatureConfig> {
   public HornbeamTreeFeature(Function<Dynamic<?>, ? extends TreeFeatureConfig> p_i225820_1_) {
      super(p_i225820_1_);
   }
