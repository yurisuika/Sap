...
public class CypressTreeFeature extends AbstractSmallTreeFeature<TreeFeatureConfig> {
   public CypressTreeFeature(Function<Dynamic<?>, ? extends TreeFeatureConfig> p_i225820_1_) {
      super(p_i225820_1_);
   }
