...
public class PlumTreeFeature extends AbstractSmallTreeFeature<TreeFeatureConfig> {
   public PlumTreeFeature(Function<Dynamic<?>, ? extends TreeFeatureConfig> p_i225820_1_) {
      super(p_i225820_1_);
   }
