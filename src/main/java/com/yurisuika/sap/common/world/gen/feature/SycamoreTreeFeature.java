...
public class SycamoreTreeFeature extends AbstractSmallTreeFeature<TreeFeatureConfig> {
   public SycamoreTreeFeature(Function<Dynamic<?>, ? extends TreeFeatureConfig> p_i225820_1_) {
      super(p_i225820_1_);
   }
