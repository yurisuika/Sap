...
public class AlderTreeFeature extends AbstractSmallTreeFeature<TreeFeatureConfig> {
   public AlderTreeFeature(Function<Dynamic<?>, ? extends TreeFeatureConfig> p_i225820_1_) {
      super(p_i225820_1_);
   }
