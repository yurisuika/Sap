...
public class RosewoodTreeFeature extends AbstractSmallTreeFeature<TreeFeatureConfig> {
   public RosewoodTreeFeature(Function<Dynamic<?>, ? extends TreeFeatureConfig> p_i225820_1_) {
      super(p_i225820_1_);
   }
