...
public class HemlockTreeFeature extends AbstractSmallTreeFeature<TreeFeatureConfig> {
   public HemlockTreeFeature(Function<Dynamic<?>, ? extends TreeFeatureConfig> p_i225820_1_) {
      super(p_i225820_1_);
   }
