...
public class MesquiteTreeFeature extends AbstractSmallTreeFeature<TreeFeatureConfig> {
   public MesquiteTreeFeature(Function<Dynamic<?>, ? extends TreeFeatureConfig> p_i225820_1_) {
      super(p_i225820_1_);
   }
