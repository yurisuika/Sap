...
public class WalnutTreeFeature extends AbstractSmallTreeFeature<TreeFeatureConfig> {
   public WalnutTreeFeature(Function<Dynamic<?>, ? extends TreeFeatureConfig> p_i225820_1_) {
      super(p_i225820_1_);
   }
