...
public class PoplarTreeFeature extends AbstractSmallTreeFeature<TreeFeatureConfig> {
   public PoplarTreeFeature(Function<Dynamic<?>, ? extends TreeFeatureConfig> p_i225820_1_) {
      super(p_i225820_1_);
   }
