...
public class FirTreeFeature extends AbstractSmallTreeFeature<TreeFeatureConfig> {
   public FirTreeFeature(Function<Dynamic<?>, ? extends TreeFeatureConfig> p_i225820_1_) {
      super(p_i225820_1_);
   }
