...
public class BayTreeFeature extends AbstractSmallTreeFeature<TreeFeatureConfig> {
   public BayTreeFeature(Function<Dynamic<?>, ? extends TreeFeatureConfig> p_i225820_1_) {
      super(p_i225820_1_);
   }
