...
public class AvocadoTreeFeature extends AbstractSmallTreeFeature<TreeFeatureConfig> {
   public AvocadoTreeFeature(Function<Dynamic<?>, ? extends TreeFeatureConfig> p_i225820_1_) {
      super(p_i225820_1_);
   }
