...
public class LimeTreeFeature extends AbstractSmallTreeFeature<TreeFeatureConfig> {
   public LimeTreeFeature(Function<Dynamic<?>, ? extends TreeFeatureConfig> p_i225820_1_) {
      super(p_i225820_1_);
   }
