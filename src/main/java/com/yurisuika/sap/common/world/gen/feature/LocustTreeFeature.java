...
public class LocustTreeFeature extends AbstractSmallTreeFeature<TreeFeatureConfig> {
   public LocustTreeFeature(Function<Dynamic<?>, ? extends TreeFeatureConfig> p_i225820_1_) {
      super(p_i225820_1_);
   }
