...
public class HickoryTreeFeature extends AbstractSmallTreeFeature<TreeFeatureConfig> {
   public HickoryTreeFeature(Function<Dynamic<?>, ? extends TreeFeatureConfig> p_i225820_1_) {
      super(p_i225820_1_);
   }
