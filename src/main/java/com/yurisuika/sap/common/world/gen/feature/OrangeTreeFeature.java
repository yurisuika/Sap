...
public class OrangeTreeFeature extends AbstractSmallTreeFeature<TreeFeatureConfig> {
   public OrangeTreeFeature(Function<Dynamic<?>, ? extends TreeFeatureConfig> p_i225820_1_) {
      super(p_i225820_1_);
   }
