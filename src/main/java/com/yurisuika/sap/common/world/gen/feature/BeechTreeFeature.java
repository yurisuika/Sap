...
public class BeechTreeFeature extends AbstractSmallTreeFeature<TreeFeatureConfig> {
   public BeechTreeFeature(Function<Dynamic<?>, ? extends TreeFeatureConfig> p_i225820_1_) {
      super(p_i225820_1_);
   }
