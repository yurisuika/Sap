...
public class HazelTreeFeature extends AbstractSmallTreeFeature<TreeFeatureConfig> {
   public HazelTreeFeature(Function<Dynamic<?>, ? extends TreeFeatureConfig> p_i225820_1_) {
      super(p_i225820_1_);
   }
