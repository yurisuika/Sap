...
public class MahoganyTreeFeature extends AbstractSmallTreeFeature<TreeFeatureConfig> {
   public MahoganyTreeFeature(Function<Dynamic<?>, ? extends TreeFeatureConfig> p_i225820_1_) {
      super(p_i225820_1_);
   }
