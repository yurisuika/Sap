...
public class LindenTreeFeature extends AbstractSmallTreeFeature<TreeFeatureConfig> {
   public LindenTreeFeature(Function<Dynamic<?>, ? extends TreeFeatureConfig> p_i225820_1_) {
      super(p_i225820_1_);
   }
