...
public class SassafrasTreeFeature extends AbstractSmallTreeFeature<TreeFeatureConfig> {
   public SassafrasTreeFeature(Function<Dynamic<?>, ? extends TreeFeatureConfig> p_i225820_1_) {
      super(p_i225820_1_);
   }
